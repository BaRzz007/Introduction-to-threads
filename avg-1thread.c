...
int main(int argc, char **argv)
{
    ...
    count = atoi(argv[1]); /* count is the first argument */
    ...
    /*
     * make an argument structure to use to pass the arguments to the
     * thread
     */
    ...
    /*
     * free the result structur
     */
    free(result);

    /*
     * free the data array -- it wasn't freed in SumThread
     */
    free(data);
